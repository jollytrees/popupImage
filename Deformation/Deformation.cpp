...
int main(int argc, char *argv[])
{
  ...
  //Mat patch_index_mask_image = imread("Results/angrybird/patch_index_mask_image.png"); const bool ENFORCE_SYMMETRY = false; const int MIDDLE_FOLD_LINE_X = IMAGE_WIDTH / 2 - 15;
  //Mat patch_index_mask_image = imread("Results/baby/patch_index_mask_image.png"); const bool ENFORCE_SYMMETRY = false; const int MIDDLE_FOLD_LINE_X = IMAGE_WIDTH / 2;
  //Mat patch_index_mask_image = imread("Results/bee/patch_index_mask_image.png"); const bool ENFORCE_SYMMETRY = true; const int MIDDLE_FOLD_LINE_X = IMAGE_WIDTH / 2;

  
  //Mat patch_index_mask_image = imread("Results/bear/patch_index_mask_image.png"); const bool ENFORCE_SYMMETRY = true; const int OFFSET = -10;
  //Mat patch_index_mask_image = imread("Results/cow/patch_index_mask_image.png"); const bool ENFORCE_SYMMETRY = false; const int OFFSET = 0;
  //Mat patch_index_mask_image = imread("Results/fox/patch_index_mask_image.png"); const bool ENFORCE_SYMMETRY = false; const int OFFSET = 0;
  Mat patch_index_mask_image = imread("Results/goat/patch_index_mask_image.png"); const bool ENFORCE_SYMMETRY = false; const int OFFSET = 0;
  

  const int IMAGE_WIDTH = patch_index_mask_image.cols;
  const int IMAGE_HEIGHT = patch_index_mask_image.rows;
  const int MIDDLE_FOLD_LINE_X = IMAGE_WIDTH / 2 + OFFSET;
